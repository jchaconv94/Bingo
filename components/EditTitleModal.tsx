      ...
      <form onSubmit={handleSubmit} className="p-4 flex flex-col gap-4 overflow-y-auto custom-scrollbar flex-1">
        ...
        <div className="flex items-center justify-between pt-4 border-t border-slate-800/50 mt-auto">
          ...
          <div className="flex gap-2">
            ...
            <button
              type="submit"
              className="px-4 py-2 bg-gradient-to-r from-cyan-600 to-cyan-500 text-white text-sm font-semibold rounded-lg transition-colors flex items-center gap-2 shadow-lg shadow-cyan-900/20"
            >
              <Save size={16} />
              Guardar
            </button>
