...
const ManagementMenu: React.FC<Props> = ({
  ...
  return createPortal(
    <div className="fixed inset-0 z-[120] flex items-center justify-center bg-black/5 backdrop-blur-md animate-in fade-in duration-300 p-0 sm:p-8">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-6">
            ...
            >
              ...
              <div className="text-center">
                ...
                <p className="text-[9px] sm:text-xs text-slate-400 line-clamp-1">Descargar cartones en imágenes</p>
              </div>
            </button>
